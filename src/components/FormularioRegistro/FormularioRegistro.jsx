      ...
      {showSuccess ? (
        ...
        <form onSubmit={handleSubmit} className="form-body">
            ...
            <div className="input-group">
              ...
              <Select classNamePrefix="custom-select" name="sexo" value={formData.sexo} options={opcionesSexo} styles={customStyles} placeholder="Seleccionar sexo..." onChange={handleSelectChange} isSearchable={false} components={{ Option: IconOption, SingleValue: IconSingleValue }} required />
            </div>
            <div className="input-group">
            ...
            <div className="input-group">
              ...
              <Select classNamePrefix="custom-select" name="categoria" value={formData.categoria} options={opcionesCategoria} styles={customStyles} placeholder="Seleccionar categoría..." onChange={handleSelectChange} isSearchable={false} required />
            </div>
